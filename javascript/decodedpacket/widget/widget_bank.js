DecodedPacketWidget.prototype.widget_12 = function(player, index, childID, slot, itemID) {
    // Bank
    if (player.isLocked()) {
        return;
    }
...
DecodedPacketWidget.prototype.widget_15 = function(player, index, childID, slot, itemID) {
    // Inventory
    if (player.isLocked()) {
        return;
    }
...
DecodedPacketWidget.prototype.widget_192 = function(player, index, childID, slot, itemID) {
    // Deposit box
    if (player.isLocked()) {
        return;
    }
...
DecodedPacketWidget.prototype.widget_14 = function(player, index, childID, slot, itemID) {
    // Pin settings
    if (player.isLocked()) {
        return;
    }
