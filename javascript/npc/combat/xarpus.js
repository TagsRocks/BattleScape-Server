...
PHASE_3_ATTACK.setType(Hit.Type.MAGIC);
PHASE_3_ATTACK.setSubType(Hit.Type.TYPELESS);
PHASE_3_ATTACK.setHitMark(Hit.POISON_MARK);
            ...
            execute: function() {
                if (event.getExecutions() == 0) {
                    ...
                    for each (var player in npc.getController().getPlayers()) {
                        ...
                        player.addHit(new HitEvent(0, player, new Hit(6, Hit.POISON_MARK)));
                    }
                }
            },
                    ...
                    execute: function(event) {
                        ...
                        if (event.getExecutions() == 1) {
                            ...
                            if (!hasPlayer && mapObject != null) {
                                ...
                                npc.addHit(new HitEvent(speed.eventDelay, npc, new Hit(6, Hit.HEAL_MARK)));
                                if (npc.getMaxHitpoints() < baseHitpoints * 1.33) {
