...
public class Woodcutting extends SkillContainer {
    private static final WoodcuttingHatchet[] HATCHETS = {
        ...
        new WoodcuttingHatchet(ItemId.DRAGON_AXE, 61, 2846), new WoodcuttingHatchet(ItemId._3RD_AGE_AXE, 61, 7264),
    ...
    public void actionSuccessHook(Player player, Event event, Npc npc, MapObject mapObject, SkillEntry entry) {
        ...
        if (Utils.randomE(nestChance - entry.getLevel()) == 0) {
            if (this.inWoodcuttingGuild(player)) {
                ...
                player.getController().addMapItem(new Item(ItemId.BIRD_NEST_5073), player, player);
            }
    ...
    static {
        entries.add(SkillEntry.builder().level(1).experience(25).mapObject(new SkillModel(1276, 0))
                ...
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 5, 8)).build());
        entries.add(SkillEntry.builder().level(15).experience(38).mapObject(new SkillModel(1751, 0))
                ...
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 8, 8)).build());
        ...
        entries.add(SkillEntry.builder().level(45).experience(100).mapObject(new SkillModel(1759, 0))
                ...
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 14, 8)).build());
        entries.add(SkillEntry.builder().level(60).experience(175).mapObject(new SkillModel(1753, 0))
                ...
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 16, 8)).build());
        entries.add(SkillEntry.builder().level(75).experience(250).mapObject(new SkillModel(1761, 0))
                ...
                .temporaryMapObject(new SkillTemporaryMapObject(1342, 20, 8)).build());
